var Knob = (function() {
  ...
  var Knob = function(input, ui) {
    ...
    container.addEventListener('keydown', this._handleKeyEvents.bind(this), false);
    container.addEventListener('mousewheel', this._handleWheelEvents.bind(this), false);
    container.addEventListener('DOMMouseScroll', this._handleWheelEvents.bind(this), false);
    container.addEventListener('touchstart', this._handleMove.bind(this, 'touchmove', 'touchend'), false);
    container.addEventListener('mousedown', this._handleMove.bind(this, 'mousemove', 'mouseup'), false);
