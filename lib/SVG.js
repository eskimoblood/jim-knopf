...
Ui.El.Arc.prototype.getCoords = function(angle) {
  ...
  var x1 = center + outerRadius * Math.cos(endAngleDegree);
  var y1 = center + outerRadius * Math.sin(endAngleDegree);
  var x2 = center + outerRadius * Math.cos(startAngleDegree);
  var y2 = center + outerRadius * Math.sin(startAngleDegree);

  var x3 = center + innerRadius * Math.cos(startAngleDegree);
  var y3 = center + innerRadius * Math.sin(startAngleDegree);
  var x4 = center + innerRadius * Math.cos(endAngleDegree);
  var y4 = center + innerRadius * Math.sin(endAngleDegree);

  var path = 'M' + x1 + ',' + y1;
  path += ' A' + outerRadius + ',' + outerRadius + ' 0 ' + ( angle < 180 ? 0 : 1) + ' 0 ' + x2 + ',' + y2;
  path += 'L' + x3 + ',' + y3;
  path += ' A' + innerRadius + ',' + innerRadius + ' 0 ' + ( angle < 180 ? 0 : 1) + ' 1 ' + x4 + ',' + y4;
  path += 'L' + x1 + ',' + y1;
  return  path;
};
